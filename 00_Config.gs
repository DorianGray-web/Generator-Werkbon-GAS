...
const CONFIG = {
  ...
  openAIReceiptsFolderId: PropertiesService.getScriptProperties().getProperty(
    "OPENAI_RECEIPTS_FOLDER_ID",
  ),
  spreadsheetId:
    PropertiesService.getScriptProperties().getProperty("SPREADSHEET_ID"),
  templateDocId:
    PropertiesService.getScriptProperties().getProperty("TEMPLATE_DOC_ID"),
  pdfOutputFolderId: PropertiesService.getScriptProperties().getProperty(
    "PDF_OUTPUT_FOLDER_ID",
  ),
  debugOpenAIResponseLogging:
